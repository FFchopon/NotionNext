...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Share life and feelings.', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'CS Student', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-lyart-beta.vercel.app/', // 网站地址
